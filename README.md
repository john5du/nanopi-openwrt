...
### 终端内在线升级方法：
```bash
wget -qO- https://github.com/john5du/nanopi-openwrt/raw/master/scripts/autoupdate-bash.sh | bash
```
slim版
```bash
wget -qO- https://github.com/john5du/nanopi-openwrt/raw/master/scripts/autoupdate-bash.sh | ver=-slim bash
```
(脚本由gary lau提供，非常感谢！)
